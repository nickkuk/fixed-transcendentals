...
impl crate::Fixed {
    ...
    pub const fn checked_from_decimal_old<const POW_OF_TEN: u32>(dec: i128) -> Option<Self> {
    ...
    pub const fn saturating_from_decimal_old<const POW_OF_TEN: u32>(dec: i128) -> Self {
    ...
    pub const fn checked_to_decimal_old<const POW_OF_TEN: u32>(self) -> Option<i128> {
    ...
    pub const fn saturating_to_decimal_old<const POW_OF_TEN: u32>(self) -> i128 {
